...
class DialogManager {
  ...
  private func dismissActon() -> UIAlertAction {
    return UIAlertAction(title: NSLocalizedString("Dismiss", comment: "Button title for dismissing the update AlertView"),
                         style: .Default) { _ in }
  }

  private func updateAction(updateURL: NSURL) -> UIAlertAction {
    return UIAlertAction(title: NSLocalizedString("Update", comment: "Button title for accepting the update AlertView"),
